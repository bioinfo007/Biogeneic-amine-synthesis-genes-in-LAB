#!/bin/bash
# Download all LAB genome assemblies using accession list
...
while read -r accession; do
    ...
    datasets download genome accession "$accession" --include genome,seq-report --filename "${OUT_DIR}/${accession}.zip"
